...
genesys_start_scan (Genesys_Device * dev, SANE_Bool lamp_off)
{
  ...
  DBG(DBG_info, "genesys_start_scan_write_registers\n");
  if (dev->productId == 0x1c05)
  {
      status = dev->model->cmd_set->probe_scan(dev, pkt1_1, sizeof(pkt1_1)/sizeof(pkt1_1[0]));
      status = dev->model->cmd_set->probe_scan(dev, pkt2_1, sizeof(pkt2_1)/sizeof(pkt2_1[0]));
      status = dev->model->cmd_set->probe_scan(dev, pkt3_1, sizeof(pkt3_1)/sizeof(pkt3_1[0]));
      status = dev->model->cmd_set->probe_scan(dev, pkt4_1, sizeof(pkt4_1)/sizeof(pkt4_1[0]));
      status = dev->model->cmd_set->probe_scan(dev, pkt5_1, sizeof(pkt5_1)/sizeof(pkt5_1[0]));
      status = dev->model->cmd_set->probe_scan(dev, pkt6_1, sizeof(pkt6_1)/sizeof(pkt6_1[0]));
      status = dev->model->cmd_set->probe_scan(dev, pkt7_1, sizeof(pkt7_1)/sizeof(pkt7_1[0]));
      status = dev->model->cmd_set->probe_scan(dev, pkt8_1, sizeof(pkt8_1)/sizeof(pkt8_1[0]));
      status = dev->model->cmd_set->probe_scan(dev, pkt9_1, sizeof(pkt9_1)/sizeof(pkt9_1[0]));
       status = dev->model->cmd_set->         probe_scan(dev, pkt10_1, sizeof(pkt10_1)/sizeof(pkt10_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt11_1, sizeof(pkt11_1)/sizeof(pkt11_1[0]));
                status = dev->model->cmd_set->probe_scan(dev, pkt12_1, sizeof(pkt12_1)/sizeof(pkt12_1[0]));
                status = dev->model->cmd_set->probe_scan(dev, pkt13_1, sizeof(pkt13_1)/sizeof(pkt13_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt14_1, sizeof(pkt14_1)/sizeof(pkt14_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt15_1, sizeof(pkt15_1)/sizeof(pkt15_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt16_1, sizeof(pkt16_1)/sizeof(pkt16_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt17_1, sizeof(pkt17_1)/sizeof(pkt17_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt18_1, sizeof(pkt18_1)/sizeof(pkt18_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt19_1, sizeof(pkt19_1)/sizeof(pkt19_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt20_1, sizeof(pkt20_1)/sizeof(pkt20_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt21_1, sizeof(pkt21_1)/sizeof(pkt21_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt22_1, sizeof(pkt22_1)/sizeof(pkt22_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt23_1, sizeof(pkt23_1)/sizeof(pkt23_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt24_1, sizeof(pkt24_1)/sizeof(pkt24_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt25_1, sizeof(pkt25_1)/sizeof(pkt25_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt26_1, sizeof(pkt26_1)/sizeof(pkt26_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt27_1, sizeof(pkt27_1)/sizeof(pkt27_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt28_1, sizeof(pkt28_1)/sizeof(pkt28_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt29_1, sizeof(pkt29_1)/sizeof(pkt29_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt30_1, sizeof(pkt30_1)/sizeof(pkt30_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt31_1, sizeof(pkt31_1)/sizeof(pkt31_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt32_1, sizeof(pkt32_1)/sizeof(pkt32_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt33_1, sizeof(pkt33_1)/sizeof(pkt33_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt34_1, sizeof(pkt34_1)/sizeof(pkt34_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt35_1, sizeof(pkt35_1)/sizeof(pkt35_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt36_1, sizeof(pkt36_1)/sizeof(pkt36_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt37_1, sizeof(pkt37_1)/sizeof(pkt37_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt38_1, sizeof(pkt38_1)/sizeof(pkt38_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt39_1, sizeof(pkt39_1)/sizeof(pkt39_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt40_1, sizeof(pkt40_1)/sizeof(pkt40_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt41_1, sizeof(pkt41_1)/sizeof(pkt41_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt42_1, sizeof(pkt42_1)/sizeof(pkt42_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt43_1, sizeof(pkt43_1)/sizeof(pkt43_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt44_1, sizeof(pkt44_1)/sizeof(pkt44_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt45_1, sizeof(pkt45_1)/sizeof(pkt45_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt46_1, sizeof(pkt46_1)/sizeof(pkt46_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt47_1, sizeof(pkt47_1)/sizeof(pkt47_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt48_1, sizeof(pkt48_1)/sizeof(pkt48_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt49_1, sizeof(pkt49_1)/sizeof(pkt49_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt50_1, sizeof(pkt50_1)/sizeof(pkt50_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt51_1, sizeof(pkt51_1)/sizeof(pkt51_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt52_1, sizeof(pkt52_1)/sizeof(pkt52_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt53_1, sizeof(pkt53_1)/sizeof(pkt53_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt54_1, sizeof(pkt54_1)/sizeof(pkt54_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt55_1, sizeof(pkt55_1)/sizeof(pkt55_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt56_1, sizeof(pkt56_1)/sizeof(pkt56_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt57_1, sizeof(pkt57_1)/sizeof(pkt57_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt58_1, sizeof(pkt58_1)/sizeof(pkt58_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt59_1, sizeof(pkt59_1)/sizeof(pkt59_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt60_1, sizeof(pkt60_1)/sizeof(pkt60_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt61_1, sizeof(pkt61_1)/sizeof(pkt61_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt62_1, sizeof(pkt62_1)/sizeof(pkt62_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt63_1, sizeof(pkt63_1)/sizeof(pkt63_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt64_1, sizeof(pkt64_1)/sizeof(pkt64_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt65_1, sizeof(pkt65_1)/sizeof(pkt65_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt66_1, sizeof(pkt66_1)/sizeof(pkt66_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt67_1, sizeof(pkt67_1)/sizeof(pkt67_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt68_1, sizeof(pkt68_1)/sizeof(pkt68_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt69_1, sizeof(pkt69_1)/sizeof(pkt69_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt70_1, sizeof(pkt70_1)/sizeof(pkt70_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt71_1, sizeof(pkt71_1)/sizeof(pkt71_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt72_1, sizeof(pkt72_1)/sizeof(pkt72_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt73_1, sizeof(pkt73_1)/sizeof(pkt73_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt74_1, sizeof(pkt74_1)/sizeof(pkt74_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt75_1, sizeof(pkt75_1)/sizeof(pkt75_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt76_1, sizeof(pkt76_1)/sizeof(pkt76_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt77_1, sizeof(pkt77_1)/sizeof(pkt77_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt78_1, sizeof(pkt78_1)/sizeof(pkt78_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt79_1, sizeof(pkt79_1)/sizeof(pkt79_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt80_1, sizeof(pkt80_1)/sizeof(pkt80_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt81_1, sizeof(pkt81_1)/sizeof(pkt81_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt82_1, sizeof(pkt82_1)/sizeof(pkt82_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt83_1, sizeof(pkt83_1)/sizeof(pkt83_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt84_1, sizeof(pkt84_1)/sizeof(pkt84_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt85_1, sizeof(pkt85_1)/sizeof(pkt85_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt86_1, sizeof(pkt86_1)/sizeof(pkt86_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt87_1, sizeof(pkt87_1)/sizeof(pkt87_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt88_1, sizeof(pkt88_1)/sizeof(pkt88_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt89_1, sizeof(pkt89_1)/sizeof(pkt89_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt90_1, sizeof(pkt90_1)/sizeof(pkt90_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt91_1, sizeof(pkt91_1)/sizeof(pkt91_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt92_1, sizeof(pkt92_1)/sizeof(pkt92_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt93_1, sizeof(pkt93_1)/sizeof(pkt93_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt94_1, sizeof(pkt94_1)/sizeof(pkt94_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt95_1, sizeof(pkt95_1)/sizeof(pkt95_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt96_1, sizeof(pkt96_1)/sizeof(pkt96_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt97_1, sizeof(pkt97_1)/sizeof(pkt97_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt98_1, sizeof(pkt98_1)/sizeof(pkt98_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt99_1, sizeof(pkt99_1)/sizeof(pkt99_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt100_1, sizeof(pkt100_1)/sizeof(pkt100_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt101_1, sizeof(pkt101_1)/sizeof(pkt101_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt102_1, sizeof(pkt102_1)/sizeof(pkt102_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt103_1, sizeof(pkt103_1)/sizeof(pkt103_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt104_1, sizeof(pkt104_1)/sizeof(pkt104_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt105_1, sizeof(pkt105_1)/sizeof(pkt105_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt106_1, sizeof(pkt106_1)/sizeof(pkt106_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt107_1, sizeof(pkt107_1)/sizeof(pkt107_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt108_1, sizeof(pkt108_1)/sizeof(pkt108_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt109_1, sizeof(pkt109_1)/sizeof(pkt109_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt110_1, sizeof(pkt110_1)/sizeof(pkt110_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt111_1, sizeof(pkt111_1)/sizeof(pkt111_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt112_1, sizeof(pkt112_1)/sizeof(pkt112_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt113_1, sizeof(pkt113_1)/sizeof(pkt113_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt114_1, sizeof(pkt114_1)/sizeof(pkt114_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt115_1, sizeof(pkt115_1)/sizeof(pkt115_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt116_1, sizeof(pkt116_1)/sizeof(pkt116_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt117_1, sizeof(pkt117_1)/sizeof(pkt117_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt118_1, sizeof(pkt118_1)/sizeof(pkt118_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt119_1, sizeof(pkt119_1)/sizeof(pkt119_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt120_1, sizeof(pkt120_1)/sizeof(pkt120_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt121_1, sizeof(pkt121_1)/sizeof(pkt121_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt122_1, sizeof(pkt122_1)/sizeof(pkt122_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt123_1, sizeof(pkt123_1)/sizeof(pkt123_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt124_1, sizeof(pkt124_1)/sizeof(pkt124_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt125_1, sizeof(pkt125_1)/sizeof(pkt125_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt126_1, sizeof(pkt126_1)/sizeof(pkt126_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt127_1, sizeof(pkt127_1)/sizeof(pkt127_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt128_1, sizeof(pkt128_1)/sizeof(pkt128_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt129_1, sizeof(pkt129_1)/sizeof(pkt129_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt130_1, sizeof(pkt130_1)/sizeof(pkt130_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt131_1, sizeof(pkt131_1)/sizeof(pkt131_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt132_1, sizeof(pkt132_1)/sizeof(pkt132_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt133_1, sizeof(pkt133_1)/sizeof(pkt133_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt134_1, sizeof(pkt134_1)/sizeof(pkt134_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt135_1, sizeof(pkt135_1)/sizeof(pkt135_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt136_1, sizeof(pkt136_1)/sizeof(pkt136_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt137_1, sizeof(pkt137_1)/sizeof(pkt137_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt138_1, sizeof(pkt138_1)/sizeof(pkt138_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt139_1, sizeof(pkt139_1)/sizeof(pkt139_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt140_1, sizeof(pkt140_1)/sizeof(pkt140_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt141_1, sizeof(pkt141_1)/sizeof(pkt141_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt142_1, sizeof(pkt142_1)/sizeof(pkt142_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt143_1, sizeof(pkt143_1)/sizeof(pkt143_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt144_1, sizeof(pkt144_1)/sizeof(pkt144_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt145_1, sizeof(pkt145_1)/sizeof(pkt145_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt146_1, sizeof(pkt146_1)/sizeof(pkt146_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt147_1, sizeof(pkt147_1)/sizeof(pkt147_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt148_1, sizeof(pkt148_1)/sizeof(pkt148_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt149_1, sizeof(pkt149_1)/sizeof(pkt149_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt150_1, sizeof(pkt150_1)/sizeof(pkt150_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt151_1, sizeof(pkt151_1)/sizeof(pkt151_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt152_1, sizeof(pkt152_1)/sizeof(pkt152_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt153_1, sizeof(pkt153_1)/sizeof(pkt153_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt154_1, sizeof(pkt154_1)/sizeof(pkt154_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt155_1, sizeof(pkt155_1)/sizeof(pkt155_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt156_1, sizeof(pkt156_1)/sizeof(pkt156_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt157_1, sizeof(pkt157_1)/sizeof(pkt157_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt158_1, sizeof(pkt158_1)/sizeof(pkt158_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt159_1, sizeof(pkt159_1)/sizeof(pkt159_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt160_1, sizeof(pkt160_1)/sizeof(pkt160_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt161_1, sizeof(pkt161_1)/sizeof(pkt161_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt162_1, sizeof(pkt162_1)/sizeof(pkt162_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt163_1, sizeof(pkt163_1)/sizeof(pkt163_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt164_1, sizeof(pkt164_1)/sizeof(pkt164_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt165_1, sizeof(pkt165_1)/sizeof(pkt165_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt166_1, sizeof(pkt166_1)/sizeof(pkt166_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt167_1, sizeof(pkt167_1)/sizeof(pkt167_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt168_1, sizeof(pkt168_1)/sizeof(pkt168_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt169_1, sizeof(pkt169_1)/sizeof(pkt169_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt170_1, sizeof(pkt170_1)/sizeof(pkt170_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt171_1, sizeof(pkt171_1)/sizeof(pkt171_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt172_1, sizeof(pkt172_1)/sizeof(pkt172_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt173_1, sizeof(pkt173_1)/sizeof(pkt173_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt174_1, sizeof(pkt174_1)/sizeof(pkt174_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt175_1, sizeof(pkt175_1)/sizeof(pkt175_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt176_1, sizeof(pkt176_1)/sizeof(pkt176_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt177_1, sizeof(pkt177_1)/sizeof(pkt177_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt178_1, sizeof(pkt178_1)/sizeof(pkt178_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt179_1, sizeof(pkt179_1)/sizeof(pkt179_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt180_1, sizeof(pkt180_1)/sizeof(pkt180_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt181_1, sizeof(pkt181_1)/sizeof(pkt181_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt182_1, sizeof(pkt182_1)/sizeof(pkt182_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt183_1, sizeof(pkt183_1)/sizeof(pkt183_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt184_1, sizeof(pkt184_1)/sizeof(pkt184_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt185_1, sizeof(pkt185_1)/sizeof(pkt185_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt186_1, sizeof(pkt186_1)/sizeof(pkt186_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt187_1, sizeof(pkt187_1)/sizeof(pkt187_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt188_1, sizeof(pkt188_1)/sizeof(pkt188_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt189_1, sizeof(pkt189_1)/sizeof(pkt189_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt190_1, sizeof(pkt190_1)/sizeof(pkt190_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt191_1, sizeof(pkt191_1)/sizeof(pkt191_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt192_1, sizeof(pkt192_1)/sizeof(pkt192_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt193_1, sizeof(pkt193_1)/sizeof(pkt193_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt194_1, sizeof(pkt194_1)/sizeof(pkt194_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt195_1, sizeof(pkt195_1)/sizeof(pkt195_1[0]));
 status = dev->model->cmd_set->               probe_scan(dev, pkt196_1, sizeof(pkt196_1)/sizeof(pkt196_1[0]));
  }
  else
  status =
